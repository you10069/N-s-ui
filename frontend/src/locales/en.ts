export default {
  ...
  configEditor: {
    ...
    unsaved: "Unsaved",
    pendingReload: "Saved, reload pending",
    read: "Read",
    copy: "Copy",
    paste: "Paste",
    check: "Check",
    reload: "Reload sing-box",
    tip: "Save writes config.json exactly as shown, including comments. Reload is manual and separate.",
    lines: "lines",
    characters: "characters",
    updatedAt: "Last modified",
    sourceTitle: "Manual config.json",
    runtimeTitle: "Running config.runtime.json",
    saved: "Saved",
    dualTip: "Edit config.json on the left. The right side shows the generated read-only configuration currently used by sing-box after user limits are applied.",
    readOnly: "Read only",
    refreshRuntime: "Refresh runtime",
    coreRunning: "Core running",
    coreStopped: "Core stopped",
    runtimeMissing: "No runtime configuration has been generated yet. Save and reload the source configuration first.",
    runtimePlaceholder: "The running configuration will appear here.",
  ...
  client: {
    ...
    sourceTip: "Users are read from the currently activated configuration. Edit config.json and click Reload to add or remove users. User names must be globally unique.",
    statsTip: "Traffic collection requires experimental.v2ray_api.stats.enabled and the same names in stats.users.",
    limitTip: "Expired, over-quota or manually disabled users are removed from the runtime config and sing-box is fully restarted. The source config.json and its comments remain untouched.",
    runtimeTip: "The quota is calculated from adjusted traffic. Saving automatically blocks or restores the user when the limit state changes.",
    status: "Status",
    statusActive: "Active",
    statusManual: "Manually disabled",
    statusExpired: "Expired",
    statusQuota: "Quota exhausted",
    statusBlocked: "Blocked",
    trafficQuota: "Traffic quota",
    trafficLimitGB: "Total traffic limit",
    remaining: "Remaining",
    manualEnable: "Allow this user to connect",
    zeroUnlimited: "Set 0 for unlimited traffic",
    multiplierHint: "Quota usage is (upload + download) × multiplier",
    offline: "Offline",
    ...
    resetConfirm: "Reset upload and download counters for this user?",
  },
  bulk: {
    add: "Add Bulk",
    order: "Order",
