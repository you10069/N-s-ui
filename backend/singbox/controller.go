...
func (s *Controller) GetActiveConfigPath() string {
	return config.GetBinFolderPath() + "/config.active.json"
}

func (s *Controller) GetRuntimeConfigPath() string {
	return config.GetBinFolderPath() + "/config.runtime.json"
}
