...
type Client struct {
	...
	Multiplier    float64         `json:"multiplier" form:"multiplier" gorm:"default:1"`
	ResetDay      int             `json:"resetDay" form:"resetDay" gorm:"default:0"`
	LastResetAt   int64           `json:"lastResetAt" form:"lastResetAt"`
	InConfig      bool            `json:"inConfig" form:"inConfig" gorm:"default:true"`
	Blocked       bool            `json:"blocked" form:"blocked" gorm:"default:false"`
	BlockedReason string          `json:"blockedReason" form:"blockedReason"`
	BlockedAt     int64           `json:"blockedAt" form:"blockedAt"`
	Adjusted      int64           `json:"adjusted" gorm:"-"`
	Remaining     int64           `json:"remaining" gorm:"-"`
